...
def main():
    ...
    initial_state = g.get_tensor_by_name("ctc_classifier/initial_state:0")
    final_state = g.get_tensor_by_name("ctc_classifier/final_state:0")
    logits = g.get_tensor_by_name("ctc_classifier/logits:0")

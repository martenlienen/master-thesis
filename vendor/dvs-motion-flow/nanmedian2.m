...
out(1:floor(filtersize/2),:)=NaN;
out(end-floor(filtersize/2)-1:end,:)=NaN;
...
for y=floor(filtersize/2)+1:ysize-floor(filtersize/2)
    for x=floor(filtersize/2)+1:xsize-floor(filtersize/2)
        if ~isnan(I(y,x))
    %         tmp=[I(y-floor(filtersize/2):y+floor(filtersize/2),x-floor(filtersize/2)); I(y-floor(filtersize/2):y+floor(filtersize/2),x); I(y-floor(filtersize/2):y+floor(filtersize/2),x+floor(filtersize/2))];
...
%     for x=floor(filtersize/2)+1:xsize-floor(filtersize/2)
%         tmp=[I(y-floor(filtersize/2):y+floor(filtersize/2),x-floor(filtersize/2)); I(y-floor(filtersize/2):y+floor(filtersize/2),x); I(y-floor(filtersize/2):y+floor(filtersize/2),x+floor(filtersize/2))];
%         count=(filtersize*filtersize)-sum(isnan(tmp));
%         if count> thr
%             out(y,x)=nanmedian(tmp);
%         else
%             out(y,x)=NaN;
